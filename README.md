...
apitareas/ │ ├── src/ │ ├── main/ │ │ ├── java/com/apitareas/ │ │ │ ├── controladores/ # Controladores REST (Autenticación y Tareas) │ │ │ ├── dto/ # Objetos de transferencia de datos (DTOs) │ │ │ ├── entidades/ # Entidades JPA (Usuario, Tarea) │ │ │ ├── repositorios/ # Repositorios JPA para acceso a datos │ │ │ ├── seguridad/ # Configuración de seguridad (JWT, autenticación) │ │ │ └── servicios/ # Lógica de negocio (Usuario, Tarea) │ │ └── resources/ │ │ ├── application.properties # Configuración general │ │ └── application-prod.properties # Configuración para producción │ └── test/ │ └── java/com/apitareas/ # Pruebas unitarias e integrales └── pom.xml # Archivo de dependencias de Maven
